...
const AuthForm = ({type}:{type:string}) => {
    ...
    const onSubmit = async(data: z.infer<typeof formSchema>)=>{
        //do someting with the form values
        setIsLoading(true)
        try{
        ...
        {user ? (
            ...
            <>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        ...
                        {type==='sign-up' && (
                            <>
                              ...
                              <div className='flex gap-4'>
                               <CustomInput control={form.control} name='state' label='State' placeholder={'Ex: Delhi'}/>
                               <CustomInput control={form.control} name='postalCode' label='Postal Code' placeholder={'Ex: 110001'}/>
                               </div>
                ...
                <footer className="flex justify-center gap-1">
                        ...
                        <Link href={type==="sign-in"?"/sign-up":"sign-in"} className='form-link'>{type==="sign-in"?"Register":"Sign In"}</Link>
                </footer>
            </>
        )}
    </section>
